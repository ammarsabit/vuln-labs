  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md text-foreground">
        <Link to="/" className="flex items-center justify-center gap-2 text-xl font-bold mb-6">
          <img src={Logo} className="inline-flex h-20 w-20 items-center justify-center font-mono text-sm font-bold" />
          <span>
        ...
        <div className="bg-card p-6 rounded-xl border border-border">
          <h1 className="text-2xl font-semibold mb-6">Create a PiedPiper account</h1>
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            <div>
              <label className="block text-muted-foreground text-sm mb-1.5">Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-muted-foreground text-sm mb-1.5">Password</label>
